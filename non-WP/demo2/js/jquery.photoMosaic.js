    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            ...
            // dat.gui
                ...
                window.PhotoMosaic.transition_mem = this.getTransition();
            // end dat.gui
        ...
        autoCols: function (){
            ...
            var maths = {
                plus : Math.floor(sizes.medium + (sizes.thumbnail / 1.2)),
                minus : Math.floor(sizes.medium - (sizes.thumbnail / 1.2))
            };
        ...
        refresh: function () {
            // dat.gui
                var dont_shuffle = (this.opts.order !== this._options.order) ? false : true;
            ...
            // dat.gui
                ...
                var json = this.makeMosaicView( dont_shuffle );
